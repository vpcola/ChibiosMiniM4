...
extern "C" {
    ...
    #if GFILE_NEED_DISKINFO || defined(__DOXYGEN__)
    /**
     * @brief					Returns the total disk size of the volume
     *
     * @details					Not supported by every file system
     *
     * @param[in] fs			The filesystem (F for FatFS)
     *
     * @param[in] drive         The logical drive prefix
     *
     ...
     */
     ...
     unsigned long long gfileGetDiskSize(char fs, const char *drive);
     /**
      * @brief					Returns the total number of bytes free
      *
      * @details				Not supported by every file system
      *
      * @param[in] fs			The filesystem (F for FatFS)
      ...
      * @api
      */
     unsigned long long gfileGetDiskFree(char fs, const char *drive);
     /**
      * @brief                  Returns the total number of clusters free
      *
      * @details                Not supported by every file system
      *
      * @param[in] fs           The filesystem (F for FatFS)
      ...
      * @api
      */
     unsigned int gfileGetDiskClusters(char fs, const char *drive);
     unsigned int gfileGetDiskClusterSize(char fs, const char *drive);
    #endif
